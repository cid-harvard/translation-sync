{
  ...
  'index': {
    'header_head': 'Colombia como usted nunca la ha visto',
    'header_subhead': 'Visualice las posibilidades de cualquier sector, cualquier producto de exportación o cualquier lugar en Colombia.',
    'profiles_head': 'Comience por nuestros perfiles',
    'profiles_subhead': 'Sólo lo esencial, en un resumen de una página',
    'profiles_cta': 'Lea el perfil de Antioquia',
    'builder_head': 'Luego vaya al graficador ',
    'builder_subhead': 'Haga sus propios gráficos y mapas',
    ...
    'present_head': 'Mapeando el presente',
    'present_subhead': 'Utilice nuestros diagramas para ver la descomposición de las exportaciones o del empleo formal de su departamento o su ciudad.',
    'future_head': 'Para avizorar el futuro',
    'future_subhead': 'Encuentre qué exportaciones o sectores productivos tienen las mejores posibilidades en su departamento o ciudad.',
    'questions_head': 'No somos una bola de cristal',
    'questions_subhead': 'Pero podemos responder muchas preguntas.',
    'location_head': 'Aprenda sobre un lugar',
    'location_q1': '¿Qué industrias emplean más gente en Bogotá?',
  ...
  'downloads': {
    'head': 'Descargar los datos',
    'cta_download': 'Descargar',
    'cta_na': 'No disponible',
    'thead_national': 'Nacional',
    'thead_departments': 'Departamentos',
    'thead_met': 'Ciudades',
    ...
    'other_head': 'Otros datos (DANE)',
    'other_copy': 'El Departamento Administrativo Nacional de Estadística, DANE,  es la fuente de todos los datos sobre el PIB y la población.',
  ...
  'graph_builder': {
    ...
    'table': {
      ...
      'distance': 'Distancia',
      'read_more': '¿No reconoces alguno de los indicadores anteriores? Encuentra las definiciones en nuestro '
    },
    'settings' : {
      'label': 'Configuración',
  ...
  'industry.show': {
    ...
    'occupation_demand': 'Ocupaciones más demandadas, 2013'
  },
  'about': {
    'project_description_name': '¿Qué es Datlas?',
